...
const TrackOrders = () => {
    ...
    return (
        <div className="max-w-3xl mx-auto px-3 sm:px-4 lg:px-6 py-6 sm:py-8 lg:py-12">
            ...
            {/* Tabs - responsive: wrap on mobile, full width buttons */}
                ...
                <div className="space-y-3 sm:space-y-4">
                    {displayedOrders.map((order) => {
                        ...
                        return (
                            ...
                            >
                                {/* Order Header - responsive flex direction on small screens */}
                                <div
                                ...
                                {/* Expanded Details - responsive grid/stack */}
                                    ...
                                    <div className="border-t border-gray-100 p-3 sm:p-4 bg-gray-50 space-y-2 sm:space-y-3">
                                        ...
                                        {isCancellable && (
                                            <button
                                                ...
                                                className="w-full sm:w-auto px-4 py-2 bg-red-600 text-white text-sm font-bold rounded-xl hover:bg-red-700 transition"
                                            >
                                                Cancel Order
                                            </button>
                                        )}
